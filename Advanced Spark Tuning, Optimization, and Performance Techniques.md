...
***Disclaimer:  The public datasets used in this blog contain very small data volumes and are used for demostration purposes only.  These Spark techniques are best applied on real-world big data volumes (i.e. terabytes & petabytes).  Hence, size, configure, and tune Spark clusters & applications accordingly.***
